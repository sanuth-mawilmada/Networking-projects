...
Objective of this lab is to configure, apply, and verify Standard Access Control Lists (ACLs) to control network traffic. 

In this lab, Standard Access Control Lists (Numbered 1-99) were implemented on the router infrastructure to enforce basic network traffic filtering and management security.
...
|   |Ethernet 0/1   |10.10.10.1   |255.255.255.252   |N/A   |WAN interface to R2   |
|R2   |Ethernet 0/0   |192.168.2.1   |255.255.255.0   |N/A   |HR LAN gateway   |
|   |Ethernet 0/1   |10.10.10.2   |255.255.255.252   |N/A   |WAN interface to R1   |
|   |Ethernet 0/2   |172.16.1.1   |255.255.255.0   |N/A   |Servers gateway   |
...
|PC1   |Ethernet 0/0   |192.168.1.10   |255.255.255.0   |192.168.1.1   |IT host   |
|PC2   |Ethernet 0/0   |192.168.1.20   |255.255.255.0   |192.168.1.1   |IT host   |
|PC3   |Ethernet 0/0   |192.168.1.30   |255.255.255.0   |192.168.1.1   |IT host   |
|PC4   |Ethernet 0/0   |192.168.2.10   |255.255.255.0   |192.168.2.1   |HR host   |
|PC5   |Ethernet 0/0   |192.168.2.20   |255.255.255.0   |192.168.2.1   |HR host   |
...
**Rule list:** [View rules](./configs/Standard_ACL_rules.txt)

**Configurations:** [View all configurations](./configs/Standard%20ACL%20Configurations.txt)

**Verifications:** [View all verifications](./configs/Standard%20ACL%20Verifications.txt)
