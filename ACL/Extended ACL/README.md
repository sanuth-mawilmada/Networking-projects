...
Objective of this lab is to configure, apply, and verify Extended Access Control Lists (ACLs) to control network traffic. 

In this lab, Extended Access Control Lists (Numbered 100-199) were implemented on the router infrastructure to enforce basic network traffic filtering and management security.
...
**Configurations:** [View all configurations](./configs/Extended%20ACL%20Configurations.txt)

**Verifications:** [View all verifications](./configs/Extended%20ACL%20Verifications.txt)
